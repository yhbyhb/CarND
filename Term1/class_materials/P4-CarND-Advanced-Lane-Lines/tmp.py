...
# def find_lanes_conv(binary_warped, nwindows = 9, margin = 100, minpix = 50):
window_width = 50 
...
if len(window_centroids) > 0:
    ...
    output = cv2.addWeighted(warpage, 1, template, 0.9, 0.0) # overlay the orignal road image with window results
